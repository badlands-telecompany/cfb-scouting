...
def get_all_cfb_teams_for_year_range(start_year, end_year):
    """
...
def cfb_job():
    ...
    url_list = get_all_cfb_teams_for_year_range(start_year, end_year)
    
    d1, d2, d3 = get_season_stats_for_url_list(url_list, get_cfb_season_stats)
    ...
    save_df_to_csv(df1, 'Data/CFB/passing.csv', col_headers=False, index=True,
                   index_label='PlayerYearID', mode='a')
    save_df_to_csv(df2, 'Data/CFB/rush_receiving.csv', col_headers=False, index=True,
                   index_label='PlayerYearID', mode='a')
    save_df_to_csv(df3, 'Data/CFB/defense.csv', col_headers=False, index=True,
                   index_label='PlayerYearID', mode='a')
